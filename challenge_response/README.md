...
| NEG_diagonal 단일 방향 확정 | 1.1% | 3.6% | <20% | 달성 |
...
- 판정 목표는 `derivation_policy.targets`를 그대로 쓴다. 흔들기: 이동 인정 0회. 대각선: 방향
  확정 윈도우 20% 미만. 손 이탈: SPEC 목표가 없어 "손이 사라지기 전 이동 인정 0회"를 본다(5.9).
